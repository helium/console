defmodule ConsoleWeb.DeviceControllerTest do
  ...
  describe "channels" do
    ...
    test "creates devices properly", %{conn: conn} do
      resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "aaaaaaaaaaaaaaaa", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => nil }
      ...
      resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "a", "app_eui" => "b", "app_key" => "c" }, "label_id" => nil }
      assert json_response(resp_conn, 422) # attrs must be correct length

      assert_error_sent 400, fn ->
        resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "a", "app_eui" => "b", "app_key" => "c" }}
      end # payload must contain label_id key

      resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "aaaaaaaaaaaaaaa1", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => nil }
    ...
    test "create devices with label linked properly", %{conn: conn} do
      ...
      assert_error_sent 400, fn ->
        resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "aaaaaaaaaaaaaaa1", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => %{} }
      end # label attr invalid type

      assert_error_sent 400, fn ->
        resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "aaaaaaaaaaaaaaa2", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => "" }
      end # label attr invalid type
      ...
      resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "aaaaaaaaaaaaaaa3", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => label_1.id }
      device = json_response(resp_conn, 201)
      device = Devices.get_device!(device["id"])
    ...
    test "updates devices properly", %{conn: conn} do
      ...
      resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "n", "dev_eui" => "aaaaaaaaaaaaaaa3", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => nil }
      device = json_response(resp_conn, 201)
      device = Devices.get_device!(device["id"])
    ...
    test "delete multiple devices properly", %{conn: conn} do
      ...
      resp_conn = post conn, device_path(conn, :create), %{ "device" => %{ "name" => "m", "dev_eui" => "aaaaaaaaaaaaaaa2", "app_eui" => "bbbbbbbbbbbbbbbb", "app_key" => "cccccccccccccccccccccccccccccccc" }, "label_id" => nil }
