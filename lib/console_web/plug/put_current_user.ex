defmodule ConsoleWeb.Plug.PutCurrentUser do
  ...
  def call(conn, _default) do
    ...
    case get_user_by_id!(unprefixed_user_id) do
      {:super} -> assign(conn, :current_user, get_user_data_map(unprefixed_user_id, :super))
      _ -> assign(conn, :current_user, get_user_data_map(unprefixed_user_id))
    end
  end

  defp get_user_data_map(user_id, super_user \\ false) do
    %User{id: user_id, super: super_user}
  end
end
