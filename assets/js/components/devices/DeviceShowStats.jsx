  ...
  render() {
    ...
    if (!showDC) {
      if (this.props.deviceStatsQuery.loading) return (
        <Card title={this.renderTitle()} bodyStyle={{ height: 272, paddingLeft: 0, paddingRight: 0 }}>
          <div style={{ overflowX: 'scroll', paddingLeft: 24, paddingRight: 24 }} className="no-scroll-bar">
