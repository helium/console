        ...
        <Col span={10} style={{ padding: "70px 80px" }}>
          ...
          <div>
            <p style={{ fontSize: "16px" }}>
              Configuration Profiles can be added to device/label nodes. The
              last Profile assigned to a device takes priority. For example, if
              a device has Profile A, and a label has Profile B, if that label
              is applied to the device then Profile B overrides Profile A.
            </p>
            <p>
              <a
                className="help-link"
