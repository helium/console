        ...
        <div style={{ padding: 20, backgroundColor: '#D3E0EE', display: 'flex', flexDirection: 'row', overflowX: 'scroll' }}>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: '100px' }}>
              <img src={HomeIcon} style={{ height: 12, marginRight: 12, position: 'relative', top: -4 }} />
              <div>
                <Text style={{ color: '#FFFFFF', fontWeight: 500, whiteSpace: 'nowrap', display: 'block' }}>ADR On</Text>
                <Text style={{ color: '#FFFFFF', whiteSpace: 'nowrap', position: 'relative', top: -4, fontSize: 10 }}>ADR</Text>
              </div>
            </div>
            <NavPointTriangle />
          </div>
        ...
        <Row gutter={30} style={{ padding: 30}}>
          <Col span={12}>
            <div style={{ padding: 20 }}>
              ...
              <Text style={{ fontSize: 16, fontWeight: 300, display: 'block', marginBottom: 15 }}>{adrText}</Text>
