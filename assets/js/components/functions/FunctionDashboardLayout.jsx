...
class FunctionDashboardLayout extends Component {
  componentDidMount() {
    ...
    this.channel.join()
    this.channel.on(`graphql:function_index_bar:${currentOrganizationId}:function_list_update`, (message) => {
    ...
    return (
      ...
      >
        <TableHeader
          ...
          onHomePage={this.props.history.location.pathname === '/functions/home'}
          ...
          extraContent={allFunctions && <FunctionBar shownFunctionId={this.props.match.params.id} functions={allFunctions || []} />}
        >
          {this.props.children}
        </TableHeader>
      </DashboardLayout>
...
export default connect(mapStateToProps, null)(
  withGql(FunctionDashboardLayout, ALL_FUNCTIONS, props => ({ fetchPolicy: 'cache-first', name: 'allFunctionsQuery' }))
)
