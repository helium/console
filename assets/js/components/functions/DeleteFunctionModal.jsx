...
class DeleteFunctionModal extends Component {
  handleSubmit = (e) => {
    ...
    analyticsLogger.logEvent("ACTION_DELETE_FUNCTION", { function: functionToDelete.id })
  ...
  render() {
    ...
    return (
      ...
      >
        <Text>Are you sure you want to delete function {functionToDelete && functionToDelete.name}?</Text>
      </Modal>
    )
  }
}
