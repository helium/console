    ...
    return(
      ...
      >
        <div className="welcomewrapper">
          ...
          <Fade bottom>
          <div className="flexwrapper" id="tip">
            <div className="bulb">
               <img src={BulbImg} style={{ height: 60 }} />
               <p>Tip 1</p>
            </div>
            <div className="tiptextwrapper">
              <p>Learn how to build Integrations with myDevices and AWS IoT.</p>
              <a href="https://www.youtube.com/watch?v=h6hgiztpgJA" target="_blank">Watch our how-to video here <Icon className="caret" type="caret-right" /></a>
            </div>
          </div>
          </Fade>
        </div>
