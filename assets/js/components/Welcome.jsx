        ...
        <MobileDisplay>
          <MobileLayout>
            <div style={{ backgroundColor: '#ffffff', padding: 15 }}>
              <div style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 30 }}>
              ...
              >
                <Text strong style={{ fontSize: 16, display: 'block' }}>Developer Docs are Live!</Text>
                <Text style={{ fontSize: 16, color: '#6A81A4', display: 'block', marginBottom: 8 }}>Looking for some guidance to get started?</Text>
                <a href="https://docs.helium.com/" target="_blank">
                  <Text style={{ fontSize: 16, fontWeight: 500, color: '#2C79EE' }}>Click Here</Text>
                </a>
              </div>
              <div style={{ backgroundColor: '#F5F7F9', padding: '20px 20px 10px 20px', borderRadius: 10, marginBottom: 15 }}>
                <Row>
              ...
              <div style={{ backgroundColor: '#F5F7F9', padding: '20px 20px 10px 20px', borderRadius: 10 }}>
                <Row>
...
export const getStartedLinks = (noFunction = false) => (
  <React.Fragment>
    ...
    { !noFunction && <Link to="/functions"><p>Apply Functions <span>to your devices</span><CaretRightOutlined className="caret" /></p></Link> }
