  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: '#F5F7F9', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-end', paddingRight: 40}}>
        ...
        <div style={{ position: 'relative' }}>
          <NavLink draggable="false" to={"/alerts"} activeClassName="is-active" className="menu-link">Alerts</NavLink>
          {history.location.pathname === '/alerts' && <img draggable="false" src={Caret} style={{ right: -16, position: 'absolute', top: 8, height: 12 }} />}
        </div>
        <div style={{ position: 'relative' }}>
        ...
        <div style={{ marginBottom: 30, position: 'relative' }}>
          <NavLink draggable="false" to={"/multi_buys"} activeClassName="is-active" className="menu-link">Multiple Packets</NavLink>
          {history.location.pathname === '/multi_buys' && <img draggable="false" src={Caret} style={{ right: -16, position: 'absolute', top: 8, height: 12 }} />}
        </div>
