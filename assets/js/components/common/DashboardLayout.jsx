                ...
                <NavDrawer />
                {
                  process.env.CONSOLE_VERSION && 
                    <Popover
                      ...
                      placement="right"
                    >
                      <Button className="version-link" icon="tool" href={process.env.RELEASE_BLOG_LINK ? process.env.RELEASE_BLOG_LINK : "https://engineering.helium.com"} target="_blank">{process.env.CONSOLE_VERSION}</Button>
                    </Popover>
                }
              </Sider>
            )
