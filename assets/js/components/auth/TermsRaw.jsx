...
class TermsRaw extends Component {
  render() {
    ...
    <p>Helium collects information to provide our services to you in the performance of a contract with you, or for our legitimate interests in better understanding our customer’s interactions and to create better products and services.  We also share personal information we collect from the site to third parties that assist us in supporting us in providing our services, in understanding how you use our Site, and to provide advertising to us and on our behalf.  These third parties are obligated to protect the information they process on our behalf in accordance with our policies and applicable law, and include: FullStory, Intercom, as well as the Google Analytics Advertising Feature.  Specifically, Helium collects and uses Users' personal information for the following purposes:
      ...
      <ul>
        <li><em>To improve customer service</em> - Your information helps us to more effectively respond to your customer service requests and support needs.  We and our service providers, such as Intercom, assist us in processing your request including through our chat box feature, which we offer for your use and convenience.
        </li>
        <li><em>To improve our Site</em> - We continually strive to improve our Site offerings based on the information and feedback we receive from you. For example, we and our service providers, including FullStory, to provide faster and better support to your customers and aid our engineering team in solving bugs and improving the user experience.
        </li>
        <li><em>To process transactions</em> - We will use the information you provide to process your order. We do not share this information with outside parties except to the extent necessary to provide the service.
        </li>
        <li><em>To send periodic emails</em> - Your email address will be used to send you information and updates pertaining to your order. It also may be used to respond to your inquiries. If you decide to opt-in to our mailing list, you will receive emails that may include company news, updates, related product or service information, etc. If at any time you would like to unsubscribe from receiving future emails, we include detailed unsubscribe instructions at the bottom of each email or you may contact us via our Site.
        </li>
        <li><em>Protect our rights or comply with legal process</em> - We may disclose your personal information to enforce our rights arising from any contracts entered into between you and Helium; to comply with any court order, legal process, or respond to any governmental or regulatory request; or to protect Helium's rights or property or the safety of Helium, our customers, employees, or others.
        </li>
        <li><em>Sale or merger</em> - We also may disclose your personal information to a buyer or other successor in the event of a merger, acquisition, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of Helium’s assets.
        </li>
        <li><em>To market other products of Services to You</em> - We may use your personal information in association with third party vendors, marketing firms or other companies to market or sell other non Helium products or services.  For example, through Google Ads and Google Analytics, we create remarketing audiences based on specific user behavior, demographic information and interest data, and share those list with Adwords.  We also use demographic and interest data in analytics reports to create automated profiles for marketing purposes.  We create segments based on demographic and interest data. We and our third party vendors, including Google, will use this information to show you ads on sites across the Internet.  We may also use cookies to serve ads based on your past visits to our website.
        </li>
      </ul>
      <p>We retain the information we collect for as long as we needed for the above mentioned legitimate business purposes.
      </p>

      <h5>Your Cookie Preferences and Do Not Track Signals</h5>
      <ul>
        <li>Some browsers may offer a "Do Not Track" feature. This Site does not currently respond to "Do Not Track" signals.
        </li>
        <li>You can opt out of Google’s use of cookies by visiting <a href="https://adssettings.google.com/"> Google’s Ad’s Settings</a>.  You may also opt-out of certain third party vendor’s use of cookies by visiting the <a href="http://optout.networkadvertising.org/?c=1#!/">Network Advertising Initiative’s</a> opt-out page.
        </li>
      </ul>

    <h5>Your Rights: Accessing, Updating or Deleting your personal information</h5>
    <p>
    ...
    <p>Helium does not intend to offer its product or Services in any jurisdiction where the offering of such products or Services would be contrary to applicable local law, and any such offer of products or Services is void if illegal under applicable law.
    </p>
