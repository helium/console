...
class GDPRPrompt extends Component {
  constructor(props) {
    super(props);
  }
...
To market other products of Services to You - We may use your personal information in association with third party vendors, marketing firms or other companies to market or sell other non Helium products or services.
...
const styled = withStyles(styles)(GDPRPrompt)
